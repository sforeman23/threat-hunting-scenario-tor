...
- [Scenario Creation](https://github.com/sforeman23/threat-hunting-scenario-tor/blob/main/event-creation.md)
...
Searched for any file that had the string "tor" in it and discovered what looks like the user "labuser" downloaded a TOR installer, did something that resulted in many TOR-related files being copied to the desktop, and the creation of a file called `tor-shopping-list.txt` on the desktop at `2025-03-05T02:00:18.0753234Z`. These events began at `2025-03-05T01:40:58.0762394Z`.

**Query used to locate events:**

```kql
DeviceFileEvents  
| where DeviceName == "spencer-mde-vm"  
| where InitiatingProcessAccountName == "labuser"  
| where FileName contains "tor"  
| where Timestamp >= datetime(2025-03-05T01:40:58.0762394Z)  
| order by Timestamp desc  
| project Timestamp, DeviceName, ActionType, FileName, FolderPath, SHA256, Account = InitiatingProcessAccountName
```
![image](https://github.com/user-attachments/assets/0fba2b72-d86e-4f9f-a317-bbc049f72697)
...
```
![image](https://github.com/user-attachments/assets/56c6e982-4d21-4c84-a042-c0f713179919)
...
Searched for any indication that user "labuser" actually opened the TOR browser. There was evidence that they did open it at `2025-03-05T01:46:20.2184481Z`. There were several other instances of `firefox.exe` (TOR) as well as `tor.exe` spawned afterwards.
...
| order by Timestamp desc
```
![image](https://github.com/user-attachments/assets/9ec0b3a8-526d-4832-b33e-974e64474c63)
...
Searched for any indication the TOR browser was used to establish a connection using any of the known TOR ports. At `2025-03-05T01:46:49.9198576Z`, an employee on the "spencer-mde-vm" device successfully established a connection to the remote IP address `37.120.184.36` on port `9001`. The connection was initiated by the process `tor.exe`, located in the folder `c:\users\labuser\desktop\tor browser\browser\torbrowser\tor\tor.exe`. There were a couple of other connections to sites over port `443`.
...
| order by Timestamp desc
```
![image](https://github.com/user-attachments/assets/8e377005-b912-4eee-b704-b2223ac461ec)
...
The user "labuser" on the "spencer-mde-vm" device initiated and completed the installation of the TOR browser. They proceeded to launch the browser, establish connections within the TOR network, and created various files related to TOR on their desktop, including a file named `tor-shopping-list.txt`. This sequence of activities indicates that the user actively installed, configured, and used the TOR browser, likely for anonymous browsing purposes, with possible documentation in the form of the "shopping list" file.
